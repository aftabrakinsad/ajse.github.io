...
<div id="main-content" class="page page_submissions">
	...
	<center>
		...
		{else}
			{capture assign="login"}<a class="link" href="{url page="login"}">{translate key="about.onlineSubmissions.login"}</a>{/capture}
			{capture assign="register"}<a class="link" href="{url page="user" op="register"}">{translate key="about.onlineSubmissions.register"}</a>{/capture}
			<div class="alert alert-info">
