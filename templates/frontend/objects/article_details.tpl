...
<article class="article-details">
	...
	<div class="row">
		...
		<section class="article-sidebar col-md-4">
			...
			<h2 class="sr-only">{translate key="plugins.themes.AJSEThemeCards.article.sidebar"}</h2>
		...
		<div class="col-md-8">
			<section class="article-main">
				...
				{* Screen-reader heading for easier navigation jumps *}
				<h2 class="sr-only">{translate key="plugins.themes.AJSEThemeCards.article.main"}</h2>
			...
			<section class="article-more-details">
				...
				{* Screen-reader heading for easier navigation jumps *}
				<h2 class="sr-only">{translate key="plugins.themes.AJSEThemeCards.article.details"}</h2>
