...
<body class="pkp_page_{$requestedPage|escape|default:"index"} pkp_op_{$requestedOp|escape|default:"index"}{if $showingLogo} has_site_logo{/if}">
	<div class="pkp_structure_page">
		...
		<nav id="accessibility-nav" class="sr-only" role="navigation" aria-label="{translate|escape key="plugins.themes.AJSEThemeCards.accessible_menu.label"}">
			<ul>
			  <li><a href="#main-navigation">{translate|escape key="plugins.themes.AJSEThemeCards.accessible_menu.main_navigation"}</a></li>
			  <li><a href="#main-content">{translate|escape key="plugins.themes.AJSEThemeCards.accessible_menu.main_content"}</a></li>
			  <li><a href="#sidebar">{translate|escape key="plugins.themes.AJSEThemeCards.accessible_menu.sidebar"}</a></li>
			</ul>
		</nav>
		...
		<link rel="stylesheet" href="{$baseUrl}/plugins/themes/AJSEThemeCards/styles/custom/header.css"/> 
		...
		<header>
			<div class="middle_header">
				<div class="header_2 AJSE_logo">
					<a href="{$baseUrl}">
                		<img src="{$baseUrl}/plugins/themes/AJSEThemeCards/Image/ajse-logo/AJSE_Header_logo.png" alt="AJSE_logo">
            		</a>
				</div>

				<div class="ajse_ISSN">
					<table class="ISSN_table">
                		<tr>
                    		<th colspan="2">ISSN</th>
                		</tr>
                		<tr>
                    		<td colspan="2">PRINT &nbsp;&nbsp;&nbsp;&nbsp;1608 - 3679</td>
                		</tr>
                		<tr>
                    		<td colspan="2">ONLINE &nbsp;&nbsp; 2520 - 4890</td>
                		</tr>
            		</table>
				</div>

				{*<div class="header_2_e ajse_email_service">
					<h4><i class="fa-solid fa-envelope"></i> Email Us:<br><a href="#"> ajse@aiub.edu</a></h4>
				</div>*}
			</div>
		</header>
